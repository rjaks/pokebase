<template>
  <div class="relative min-h-screen lg:h-screen lg:overflow-hidden bg-gray-50 flex items-center transition-colors duration-500" :style="{ '--type-color': mainColor }">
    ...
    <div class="absolute top-6 w-full px-6 flex justify-between items-center z-50 pointer-events-none">
      ...
      <div class="pointer-events-auto absolute left-1/2 -translate-x-1/2 flex items-center gap-2">
        ...
        <div 
          ...
          :class="isScrolled && pokemon && !showSkeleton ? 'max-w-[200px] opacity-100 px-5 py-2.5 mx-1' : 'max-w-0 opacity-0 border-transparent m-0'"
        >
          <span class="font-black capitalize whitespace-nowrap transition-colors duration-500" :style="{ color: darkColor }">
            {{ pokemon?.name }}
          </span>
        </div>
    ...
    <Transition name="poke-fade" mode="out-in">
      ...
      <!-- SKELETON LOADER -->
      <div v-if="showSkeleton" :key="'skeleton-' + currentId" class="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 p-6 lg:p-12 h-full mt-16 lg:mt-0 animate-pulse">
      ...
      <!-- MAIN CONTENT -->
      <div v-else-if="pokemon" :key="'content-' + currentId" class="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 p-6 lg:p-12 h-full mt-16 lg:mt-0">
        ...
        <div @scroll="handleScroll" class="lg:col-span-7 flex flex-col justify-start space-y-6 h-full pt-6 pb-12 overflow-y-auto no-scrollbar">
          ...
          <!-- Headers -->
          <div class="flex flex-col gap-1 animate-slide-in-left" style="animation-delay: 50ms;">
            <span class="text-xs font-bold text-gray-400 tracking-widest uppercase">
              {{ category }}
            </span>

            <div class="flex items-baseline gap-3">
              <h1 class="text-5xl lg:text-6xl font-black capitalize leading-tight transition-colors duration-500"
          ...
          <!-- Description -->
          <p class="text-lg text-gray-600 font-medium italic bg-white/70 backdrop-blur-md p-5 rounded-2xl shadow-sm border border-white animate-slide-in-left" style="animation-delay: 100ms;">
            "{{ description }}"
          </p>

          <!-- Stats -->
          <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 animate-slide-in-left" style="animation-delay: 150ms;">
          ...
          <!-- Types & Weaknesses -->
          <div class="flex flex-wrap gap-10 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 animate-slide-in-left" style="animation-delay: 200ms;">
            <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-slide-in-left" style="animation-delay: 250ms;">
            <div>
          ...
          <!-- Evolutions -->
          <div class="mt-4 flex-1 pb-10 animate-slide-in-left" style="animation-delay: 300ms;" v-if="evolutions.length > 1">
        ...
        <!-- Right Column -->
        <div class="lg:col-span-5 flex flex-col items-center justify-center relative min-h-[50vh] lg:min-h-0 animate-slide-in-right" style="animation-delay: 150ms;">
